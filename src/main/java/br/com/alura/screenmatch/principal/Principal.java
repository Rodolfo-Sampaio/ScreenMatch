...
public class Principal {
    ...
    String omdbKey = OmdbConfig.getOmdbKey();
    private final String API_KEY = "&apikey=" + omdbKey;
    ...
    private void buscarSeriesPorAtor() {
        ...
        seriesEncontradas.forEach(s ->
                System.out.println(s.getTitulo() + " avalianção: " + s.getAvaliacao()));
    }
    ...
    private void  buscarEpisodioPorTrecho(){
        System.out.println("Qual o nome ou parte do nome do episódio para busca?");
